---
description: "Create a well-structured pull request with clean commits and a proper description"
---
...
- **Build Test**: Must pass before commit (see `docs/GOLDEN_RULES.md`)
...
- **Reference**: See `docs/GOLDEN_RULES.md` for commit standards
