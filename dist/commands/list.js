...
export async function listCommand(type = 'commands', options) {
...
async function listCommands(commandsDir, options) {
...
async function listSpecs(cwd, options) {
...
async function listChanges(cwd, options) {
